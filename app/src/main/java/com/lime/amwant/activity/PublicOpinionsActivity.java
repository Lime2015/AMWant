 ...
 */
public class PublicOpinionsActivity extends ActionBarActivity {

    private final String TAG = "PublicOpinionsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvNavList.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        ...
        changeColor(getResources().getColor(android.R.color.holo_red_dark));
...
//        MenuItem logoutItem = menu.findItem(R.id.action_logout);
        ...
        SearchManager searchManager = (SearchManager) PublicOpinionsActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(PublicOpinionsActivity.this.getComponentName()));
        }
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = {"국회의원", "의안"};
